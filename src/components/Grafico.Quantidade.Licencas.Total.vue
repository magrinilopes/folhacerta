<template>
  <div class="panel-graph">
    <div class="dash-graph">
      ...
      <span>(TOTAL)</span>
      <div class="graph" id="graph_qtdeLicencaTotal"></div>
    </div>
  </div>
</template>
  ...
  export default {
    ...
    methods: Object.assign({},
      mapActions(['getDataGraph']),
      {
        loadGraph(){
          let me = this;
          this['getDataGraph']('grafico-licenca-medica-total').then(ret => {
            if(ret.ok){
        ...
        treatDataGraph(data){
          ...
          this.createGraphQtdeLicencaTotal();
        },
        createGraphQtdeLicencaTotal(){
          window.AmCharts.makeChart("graph_qtdeLicencaTotal", {
            "type": "serial",
            "legend": {
              "position": "bottom",
