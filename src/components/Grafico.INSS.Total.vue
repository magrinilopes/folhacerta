<template>
  <div class="panel-graph">
    <div class="dash-graph">
      ...
      <span>(TOTAL)</span>
      <div class="graph" id="graph_inssTotal"></div>
    </div>
  </div>
</template>
  ...
  export default {
    ...
    methods: Object.assign({},
      mapActions(['getDataGraph']),
      {
        loadGraph(){
          let me = this;
          this['getDataGraph']('grafico-encaminhamento-inss').then(ret => {
            if(ret.ok){
        ...
        treatDataGraph(data){
          ...
          this.createGraphINSSTotal();
        },
        createGraphINSSTotal(){
          window.AmCharts.makeChart("graph_inssTotal", {
            "type": "serial",
            "legend": {
              "position": "bottom",
