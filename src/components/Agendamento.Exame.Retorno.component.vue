      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title">AGENDAMENTO EXAME DE RETORNO</h4>
          </div>
  ...
  export default {
    ...
    methods: Object.assign({},
      mapActions(['postAgendamentos']),
      {
        ...
        getClassName(){
          return `agenda_exame_${this.relId}`;
        },
        ...
        abrirModal(){
          $(`.agenda_exame_${this.relId}`).modal('show');
        },
        fecharModal(){
          this.setInitialDate();
          this.endereco_agenda = '';
          $(`.agenda_exame_${this.relId}`).modal('hide');
        },
        agendar(){
          let obj = {
