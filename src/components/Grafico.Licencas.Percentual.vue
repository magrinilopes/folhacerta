<template>
  <div class="panel-graph">
    <div class="dash-graph">
      ...
      <span>(%)</span>
      <div class="graph" id="graph_LicencaPercentual"></div>
    </div>
  </div>
</template>
  ...
  export default {
    ...
    methods: Object.assign({},
      mapActions(['getDataGraph']),
      {
        loadGraph(){
          let me = this;
          this['getDataGraph']('grafico-licencas-percentual').then(ret => {
            if(ret.ok){
        ...
        treatDataGraph(data){
          ...
          this.createGraphLicencaPercentual();
        },
        createGraphLicencaPercentual(){
          window.AmCharts.makeChart("graph_LicencaPercentual", {
            "type": "serial",
            "autoMargins": true,
            "marginTop": 50,
            "legend": {
